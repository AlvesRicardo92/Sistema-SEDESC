...
/**
 * Classe de migração para criar a tabela 'bairros'.
 */
class CriarTabelaBairros
{
    /**
    ...
    {
        $sql = "DROP TABLE IF EXISTS bairros;";
        try {
            Database::execute($sql);
            echo "  - Tabela 'bairros' removida.\n";
        } catch (DatabaseException $e) {
            throw new DatabaseException("Erro ao remover a tabela 'bairros': " . $e->getMessage(), 0, $e);
        }
    }
}
