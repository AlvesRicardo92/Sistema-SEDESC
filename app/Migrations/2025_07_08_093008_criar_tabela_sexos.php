...
/**
 * Classe de migração para criar a tabela 'sexos'.
 */
class CriarTabelaSexos
{
    /**
    ...
    {
        $sql = "DROP TABLE IF EXISTS sexos;";
        try {
            Database::execute($sql);
            echo "  - Tabela 'sexos' removida.\n";
        } catch (DatabaseException $e) {
            throw new DatabaseException("Erro ao remover a tabela 'sexos': " . $e->getMessage(), 0, $e);
        }
    }
}
